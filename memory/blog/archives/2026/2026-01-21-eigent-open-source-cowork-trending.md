...
詳細工具指南與配置見：
- **[Eigent：開源多智能體工作流桌面應用](../../action/tools/eigent-open-source-cowork.md)**
- **[多 Agent 編隊協作 Playbook](../../cognition/methodology/agent-management/03-playbook-multi-agent-squad.md)**
