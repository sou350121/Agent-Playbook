# 05 — 戰略生存 (Strategy & Positioning)

> 技術能力是必要條件，但不是充分條件。
> 本模塊解決：在 AI 重塑一切的時代，工程師如何定位、如何變現、如何持續進化。

---

## 本模塊定位

這裡的「戰略」不是商業戰略課，而是**工程師的個人決策框架**：
- 哪些技能值得投資，哪些會被 Agent 替代？
- 如何把技術優勢轉化為可持續的收入？
- Agentic 時代的工程師角色如何演進？
...
工程師的核心競爭力不再是「寫代碼」，而是**設計讓 Agent 工作的系統**。
...
**重塑認知**：
```
reconstructing-engineering-mindset → the-three-understandings-of-ai-coding
```

**確定定位**：
```
intelligence-arbitrage-strategy → research-taste-as-value-function → backend-engineer-roadmap-evolution
```

**落地變現**：
```
monetization-strategy-for-solo-developers → vibe-coding-deployment-friction → x-distribution-and-monetization
```
